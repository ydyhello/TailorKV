...
class ModelArguments:
    ...
    recent_size: Optional[int] = field(
        default=56,
        metadata={"help": "recent size."},
    )
    start_size: Optional[int] = field(
        default=8,
        metadata={"help": "start size."},
    )
    num_channel: Optional[int] = field(
        default=8,
        metadata={"help": "number of channels."},
    )
    ...
    budget: Optional[int] = field(
        default=128,
        metadata={"help": "KV_cache budget."},
    )
    method: Optional[str] = field(
        default="none",
        metadata={"help": "KV_cache method."},
    )
    is_search: Optional[bool] = field(
        default=False,
        metadata={"help": "KV_cache is_search."},
    )
    config_path: Optional[str] = field(
        default=None,
        metadata={"help": "KV_cache config_path."},
    )
